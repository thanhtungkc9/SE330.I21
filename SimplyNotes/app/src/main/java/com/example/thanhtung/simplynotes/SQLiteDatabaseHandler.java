...
public class SQLiteDatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table "+TABLE_NAME+ "(id integer primary key autoincrement, tieude text,noidung text,maunen text, mauchu text, theloai text, ngaytao text, ngaynhacnho text, thoigianchinhsuacuoi text)");
    ...
    public GhiChu getNote(int noteId) {
        ...
        if(cursor != null)
            cursor.moveToFirst();
        GhiChu ghiChu = new GhiChu(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4), cursor.getString(5), cursor.getString(6),cursor.getString(7),cursor.getString(8));
        return ghiChu;
    }
